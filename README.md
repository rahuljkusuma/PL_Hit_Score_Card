# PL APPLICATION SCORE CARD

### Objective:
As we know that bureau credit score is based on generalised population. So now our the objective of this PL Application Score Card is to seperate the risk customers from our company's portfolio. The main purpose of developing this credit risk model is identify the risky customer from a concentrated pool of customer base. This credit risk model developed on concentrate pool will give better picture of risk as compared to generalised population. 
